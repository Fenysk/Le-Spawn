...
export class ShippingService {
    ...
    async createRelayExpedition(orderId: string) {
        ...
        const expeditionAddressId = order.Item.User.defaultSellerAddressId;
        ...
        const expeditionInfos = {
            firstName: expeditionAddress.User.PersonalInformation.firstName,
            lastName: expeditionAddress.User.PersonalInformation.lastName,
            ...
            phoneNumber: expeditionAddress.phoneNumber,
        ...
        const destinationInfos = {
            ...
            firstName: destinationAddress.User.PersonalInformation.firstName,
            lastName: destinationAddress.User.PersonalInformation.lastName,
    ...
    async checkAndUpdateShippingStatus(orderId: string): Promise<any> {
        ...
        const expeditionNumber = order.Shipping.expeditionNumber;
        if (!expeditionNumber)
